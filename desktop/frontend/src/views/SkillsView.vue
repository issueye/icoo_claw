...
<template>
  <section class="scrollbar-thin h-full overflow-y-auto px-5 py-5">
              ...
              <div class="min-w-0">
                <div class="flex min-w-0 flex-wrap items-center gap-2">
                  ...
                  <span
                    ...
                    :class="skill.status === 'active' ? 'bg-[var(--qq-status-success-bg)] text-[var(--qq-status-success-text)]' : 'bg-[var(--qq-fill-medium)] text-[color:var(--qq-text-tertiary)]'"
                  >
    ...
    <QqModal
      ...
      title="导入技能包"
    >
      <div v-if="importDialog.error" class="rounded-[6px] border border-rose-300/20 bg-[var(--qq-status-error-bg)] px-3 py-3 text-sm leading-6 text-[var(--qq-status-error-text)]">
        {{ importDialog.error }}
      </div>
      ...
      <div v-else class="rounded-[6px] border border-white/10 bg-[var(--qq-fill-subtle)] px-3 py-3 text-sm text-[color:var(--qq-text-secondary)]">
        正在读取技能包...
      </div>
