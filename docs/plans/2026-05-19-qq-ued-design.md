...
本规范用于给 `desktop/frontend` 提供一套接近 QQ 客户端气质的基础设计语言。重点不是复刻聊天主界面，而是抽取其稳定视觉特征并封装成能复用于业务页面的组件层。风格关键字包括：青绿主色、半透明玻璃面板、粉色辅助点缀、胶囊圆角、轻量分割线、弱化卡片边界。
...
尺寸统一使用 44/48 控件高度，16/24/28 圆角节奏。输入框、按钮、标签、筛选器共享同一套圆角与焦点态。
