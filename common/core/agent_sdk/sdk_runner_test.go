...
func (m *memoryHistoryStore) ListMessages(context.Context, string) ([]HistoryMessage, error) {
	return append([]HistoryMessage(nil), m.messages...), nil
}

func (m *memoryHistoryStore) ReplaceMessages(_ context.Context, _ string, messages []HistoryMessage) error {
	m.messages = append([]HistoryMessage(nil), messages...)
	return nil
}
...
func TestSDKRunnerRunLoadsAndSavesHistory(t *testing.T) {
	store := &memoryHistoryStore{
		messages: []HistoryMessage{{Role: "user", Content: "previous"}},
	}
